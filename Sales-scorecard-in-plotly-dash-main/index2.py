...
server = app.server  # Utilisation de l'instance de Flask de Dash
...
def update_dropdown():
    ...
    print("Données reçues de Rasa:", fournisseur)
    return jsonify({'message': 'Dropdown updated successfully'})

# Define a callback to update the dropdown options based on the fournisseur value received from the Rasa API
@app.callback(Output('dropdown_fournisseurs', 'options'), [Input('input', 'children')])
def update_dropdown_options(fournisseur):
    if fournisseur:
        options = [{'label': f, 'value': f} for f in fournisseur]
    else:
        options = []  # Si aucune donnée n'est reçue, les options sont vides
    return options
...
@app.callback(
    ...
    [Input('aggrandir_button1', 'n_clicks'),
     ...
     Input('bar_chart1', 'style'),
     Input('donut_chart', 'style'),
     Input('pie_chart', 'style'),
     Input('line_chart', 'style')]
)
def toggle_graph_visibility(n_clicks1, n_clicks2, n_clicks3, n_clicks4, style_bar, style_donut, style_pie, style_line):
    ...
    if button_id == 'aggrandir_button1' and style_bar.get('height') == '280px':
        return [{'height': '600px', 'padding-top': '27px'}, {'display': 'none'}, style_pie, style_line, {'display': 'block'}, {'display': 'none'}, {'display': 'none'}, {'display': 'none'}]
    elif button_id == 'aggrandir_button2' and style_donut.get('height') == '280px':
        return [{'display': 'none'}, {'height': '600px', 'padding-top': '38px'}, style_pie, style_line, {'display': 'none'}, {'display': 'block'}, {'display': 'none'}, {'display': 'none'}]
    elif button_id == 'aggrandir_button3' and style_pie.get('height') == '280px':
        return [style_bar, style_donut, {'height': '600px', 'padding-top': '38px'}, style_line, {'display': 'none'}, {'display': 'none'}, {'display': 'block'}, {'display': 'none'}]
    elif button_id == 'aggrandir_button4' and style_line.get('height') == '300px':
        return [style_bar, style_donut, style_pie, {'height': '600px', 'padding-top': '38px'}, {'display': 'none'}, {'display': 'none'}, {'display': 'none'}, {'display': 'block'}]
    else:
        return [{'height': '280px', 'padding-top': '27px'}, {'height': '280px', 'padding-top': '38px'}, {'height': '280px', 'padding-top': '38px'}, {'height': '300px', 'padding-top': '38px'}, {'display': 'block'}, {'display': 'block'}, {'display': 'block'}, {'display': 'block'}]
...
#     if button_state:
#         return [{'display': 'none'}] * 2 + [{'display': 'block'}, button_text]
#     # Sinon, afficher les Block_div sauf Block_div5
#     return [{'display': 'block'}] * 2 + [{'display': 'none'}, button_text]
