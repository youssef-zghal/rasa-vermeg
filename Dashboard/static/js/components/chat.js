        ...
        if (Object.hasOwnProperty.call(response[i], "text")) {
          if (response[i].text != null) {
            ...
            console.log(html);
              ...
              // Contrôle du ton (entre 0 et 2, 1 étant normal)
              msg.pitch = 1;
                  // Contrôle du débit de la parole (entre 0.1 et 10, 1 étant normal)
              msg.rate = 1.5;
          
             // Contrôle du volume (entre 0 et 1, 1 étant le volume maximum)
              msg.volume = 1;
            
              msg.text = html;
              var element = document.getElementById("sound-on");
              var classe = element.className;
              if (classe == "fa fa-volume-up" ){
